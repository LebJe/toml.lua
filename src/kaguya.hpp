...
template <class T> class optional {
  ...
  private:
	...
	typename standard::aligned_storage<sizeof(T), standard::alignment_of<T>::value>::type storage_;
...
template <typename T, typename Enable = void> struct is_usertype : traits::false_type {};
template <typename T>
...
#define KAGUYA_PP_REPEAT_DEF_VA_ARG1(MACRO, ...)                                                   \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG0(MACRO, __VA_ARGS__) MACRO(1, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG2(MACRO, ...)                                                   \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG1(MACRO, __VA_ARGS__) MACRO(2, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG3(MACRO, ...)                                                   \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG2(MACRO, __VA_ARGS__) MACRO(3, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG4(MACRO, ...)                                                   \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG3(MACRO, __VA_ARGS__) MACRO(4, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG5(MACRO, ...)                                                   \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG4(MACRO, __VA_ARGS__) MACRO(5, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG6(MACRO, ...)                                                   \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG5(MACRO, __VA_ARGS__) MACRO(6, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG7(MACRO, ...)                                                   \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG6(MACRO, __VA_ARGS__) MACRO(7, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG8(MACRO, ...)                                                   \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG7(MACRO, __VA_ARGS__) MACRO(8, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG9(MACRO, ...)                                                   \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG8(MACRO, __VA_ARGS__) MACRO(9, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG10(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG9(MACRO, __VA_ARGS__) MACRO(10, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG11(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG10(MACRO, __VA_ARGS__) MACRO(11, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG12(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG11(MACRO, __VA_ARGS__) MACRO(12, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG13(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG12(MACRO, __VA_ARGS__) MACRO(13, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG14(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG13(MACRO, __VA_ARGS__) MACRO(14, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG15(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG14(MACRO, __VA_ARGS__) MACRO(15, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG16(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG15(MACRO, __VA_ARGS__) MACRO(16, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG17(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG16(MACRO, __VA_ARGS__) MACRO(17, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG18(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG17(MACRO, __VA_ARGS__) MACRO(18, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG19(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG18(MACRO, __VA_ARGS__) MACRO(19, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG20(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG19(MACRO, __VA_ARGS__) MACRO(20, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG21(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG20(MACRO, __VA_ARGS__) MACRO(21, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG22(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG21(MACRO, __VA_ARGS__) MACRO(22, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG23(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG22(MACRO, __VA_ARGS__) MACRO(23, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG24(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG23(MACRO, __VA_ARGS__) MACRO(24, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG25(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG24(MACRO, __VA_ARGS__) MACRO(25, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG26(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG25(MACRO, __VA_ARGS__) MACRO(26, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG27(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG26(MACRO, __VA_ARGS__) MACRO(27, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG28(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG27(MACRO, __VA_ARGS__) MACRO(28, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG29(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG28(MACRO, __VA_ARGS__) MACRO(29, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG30(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG29(MACRO, __VA_ARGS__) MACRO(30, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG31(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG30(MACRO, __VA_ARGS__) MACRO(31, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG32(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG31(MACRO, __VA_ARGS__) MACRO(32, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG33(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG32(MACRO, __VA_ARGS__) MACRO(33, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG34(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG33(MACRO, __VA_ARGS__) MACRO(34, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG35(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG34(MACRO, __VA_ARGS__) MACRO(35, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG36(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG35(MACRO, __VA_ARGS__) MACRO(36, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG37(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG36(MACRO, __VA_ARGS__) MACRO(37, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG38(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG37(MACRO, __VA_ARGS__) MACRO(38, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG39(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG38(MACRO, __VA_ARGS__) MACRO(39, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG40(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG39(MACRO, __VA_ARGS__) MACRO(40, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG41(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG40(MACRO, __VA_ARGS__) MACRO(41, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG42(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG41(MACRO, __VA_ARGS__) MACRO(42, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG43(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG42(MACRO, __VA_ARGS__) MACRO(43, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG44(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG43(MACRO, __VA_ARGS__) MACRO(44, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG45(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG44(MACRO, __VA_ARGS__) MACRO(45, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG46(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG45(MACRO, __VA_ARGS__) MACRO(46, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG47(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG46(MACRO, __VA_ARGS__) MACRO(47, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG48(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG47(MACRO, __VA_ARGS__) MACRO(48, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG49(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG48(MACRO, __VA_ARGS__) MACRO(49, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG50(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG49(MACRO, __VA_ARGS__) MACRO(50, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG51(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG50(MACRO, __VA_ARGS__) MACRO(51, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG52(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG51(MACRO, __VA_ARGS__) MACRO(52, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG53(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG52(MACRO, __VA_ARGS__) MACRO(53, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG54(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG53(MACRO, __VA_ARGS__) MACRO(54, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG55(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG54(MACRO, __VA_ARGS__) MACRO(55, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG56(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG55(MACRO, __VA_ARGS__) MACRO(56, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG57(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG56(MACRO, __VA_ARGS__) MACRO(57, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG58(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG57(MACRO, __VA_ARGS__) MACRO(58, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG59(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG58(MACRO, __VA_ARGS__) MACRO(59, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG60(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG59(MACRO, __VA_ARGS__) MACRO(60, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG61(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG60(MACRO, __VA_ARGS__) MACRO(61, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG62(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG61(MACRO, __VA_ARGS__) MACRO(62, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG63(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG62(MACRO, __VA_ARGS__) MACRO(63, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG64(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG63(MACRO, __VA_ARGS__) MACRO(64, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG65(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG64(MACRO, __VA_ARGS__) MACRO(65, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG66(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG65(MACRO, __VA_ARGS__) MACRO(66, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG67(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG66(MACRO, __VA_ARGS__) MACRO(67, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG68(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG67(MACRO, __VA_ARGS__) MACRO(68, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG69(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG68(MACRO, __VA_ARGS__) MACRO(69, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG70(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG69(MACRO, __VA_ARGS__) MACRO(70, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG71(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG70(MACRO, __VA_ARGS__) MACRO(71, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG72(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG71(MACRO, __VA_ARGS__) MACRO(72, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG73(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG72(MACRO, __VA_ARGS__) MACRO(73, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG74(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG73(MACRO, __VA_ARGS__) MACRO(74, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG75(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG74(MACRO, __VA_ARGS__) MACRO(75, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG76(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG75(MACRO, __VA_ARGS__) MACRO(76, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG77(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG76(MACRO, __VA_ARGS__) MACRO(77, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG78(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG77(MACRO, __VA_ARGS__) MACRO(78, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG79(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG78(MACRO, __VA_ARGS__) MACRO(79, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG80(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG79(MACRO, __VA_ARGS__) MACRO(80, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG81(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG80(MACRO, __VA_ARGS__) MACRO(81, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG82(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG81(MACRO, __VA_ARGS__) MACRO(82, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG83(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG82(MACRO, __VA_ARGS__) MACRO(83, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG84(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG83(MACRO, __VA_ARGS__) MACRO(84, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG85(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG84(MACRO, __VA_ARGS__) MACRO(85, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG86(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG85(MACRO, __VA_ARGS__) MACRO(86, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG87(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG86(MACRO, __VA_ARGS__) MACRO(87, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG88(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG87(MACRO, __VA_ARGS__) MACRO(88, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG89(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG88(MACRO, __VA_ARGS__) MACRO(89, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG90(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG89(MACRO, __VA_ARGS__) MACRO(90, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG91(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG90(MACRO, __VA_ARGS__) MACRO(91, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG92(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG91(MACRO, __VA_ARGS__) MACRO(92, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG93(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG92(MACRO, __VA_ARGS__) MACRO(93, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG94(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG93(MACRO, __VA_ARGS__) MACRO(94, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG95(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG94(MACRO, __VA_ARGS__) MACRO(95, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG96(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG95(MACRO, __VA_ARGS__) MACRO(96, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG97(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG96(MACRO, __VA_ARGS__) MACRO(97, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG98(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG97(MACRO, __VA_ARGS__) MACRO(98, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG99(MACRO, ...)                                                  \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG98(MACRO, __VA_ARGS__) MACRO(99, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG100(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG99(MACRO, __VA_ARGS__) MACRO(100, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG101(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG100(MACRO, __VA_ARGS__) MACRO(101, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG102(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG101(MACRO, __VA_ARGS__) MACRO(102, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG103(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG102(MACRO, __VA_ARGS__) MACRO(103, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG104(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG103(MACRO, __VA_ARGS__) MACRO(104, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG105(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG104(MACRO, __VA_ARGS__) MACRO(105, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG106(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG105(MACRO, __VA_ARGS__) MACRO(106, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG107(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG106(MACRO, __VA_ARGS__) MACRO(107, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG108(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG107(MACRO, __VA_ARGS__) MACRO(108, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG109(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG108(MACRO, __VA_ARGS__) MACRO(109, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG110(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG109(MACRO, __VA_ARGS__) MACRO(110, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG111(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG110(MACRO, __VA_ARGS__) MACRO(111, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG112(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG111(MACRO, __VA_ARGS__) MACRO(112, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG113(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG112(MACRO, __VA_ARGS__) MACRO(113, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG114(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG113(MACRO, __VA_ARGS__) MACRO(114, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG115(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG114(MACRO, __VA_ARGS__) MACRO(115, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG116(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG115(MACRO, __VA_ARGS__) MACRO(116, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG117(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG116(MACRO, __VA_ARGS__) MACRO(117, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG118(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG117(MACRO, __VA_ARGS__) MACRO(118, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG119(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG118(MACRO, __VA_ARGS__) MACRO(119, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG120(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG119(MACRO, __VA_ARGS__) MACRO(120, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG121(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG120(MACRO, __VA_ARGS__) MACRO(121, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG122(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG121(MACRO, __VA_ARGS__) MACRO(122, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG123(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG122(MACRO, __VA_ARGS__) MACRO(123, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG124(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG123(MACRO, __VA_ARGS__) MACRO(124, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG125(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG124(MACRO, __VA_ARGS__) MACRO(125, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG126(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG125(MACRO, __VA_ARGS__) MACRO(126, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG127(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG126(MACRO, __VA_ARGS__) MACRO(127, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG128(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG127(MACRO, __VA_ARGS__) MACRO(128, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG129(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG128(MACRO, __VA_ARGS__) MACRO(129, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG130(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG129(MACRO, __VA_ARGS__) MACRO(130, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG131(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG130(MACRO, __VA_ARGS__) MACRO(131, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG132(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG131(MACRO, __VA_ARGS__) MACRO(132, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG133(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG132(MACRO, __VA_ARGS__) MACRO(133, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG134(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG133(MACRO, __VA_ARGS__) MACRO(134, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG135(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG134(MACRO, __VA_ARGS__) MACRO(135, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG136(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG135(MACRO, __VA_ARGS__) MACRO(136, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG137(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG136(MACRO, __VA_ARGS__) MACRO(137, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG138(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG137(MACRO, __VA_ARGS__) MACRO(138, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG139(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG138(MACRO, __VA_ARGS__) MACRO(139, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG140(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG139(MACRO, __VA_ARGS__) MACRO(140, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG141(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG140(MACRO, __VA_ARGS__) MACRO(141, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG142(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG141(MACRO, __VA_ARGS__) MACRO(142, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG143(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG142(MACRO, __VA_ARGS__) MACRO(143, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG144(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG143(MACRO, __VA_ARGS__) MACRO(144, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG145(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG144(MACRO, __VA_ARGS__) MACRO(145, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG146(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG145(MACRO, __VA_ARGS__) MACRO(146, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG147(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG146(MACRO, __VA_ARGS__) MACRO(147, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG148(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG147(MACRO, __VA_ARGS__) MACRO(148, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG149(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG148(MACRO, __VA_ARGS__) MACRO(149, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG150(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG149(MACRO, __VA_ARGS__) MACRO(150, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG151(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG150(MACRO, __VA_ARGS__) MACRO(151, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG152(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG151(MACRO, __VA_ARGS__) MACRO(152, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG153(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG152(MACRO, __VA_ARGS__) MACRO(153, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG154(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG153(MACRO, __VA_ARGS__) MACRO(154, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG155(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG154(MACRO, __VA_ARGS__) MACRO(155, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG156(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG155(MACRO, __VA_ARGS__) MACRO(156, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG157(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG156(MACRO, __VA_ARGS__) MACRO(157, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG158(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG157(MACRO, __VA_ARGS__) MACRO(158, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG159(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG158(MACRO, __VA_ARGS__) MACRO(159, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG160(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG159(MACRO, __VA_ARGS__) MACRO(160, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG161(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG160(MACRO, __VA_ARGS__) MACRO(161, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG162(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG161(MACRO, __VA_ARGS__) MACRO(162, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG163(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG162(MACRO, __VA_ARGS__) MACRO(163, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG164(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG163(MACRO, __VA_ARGS__) MACRO(164, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG165(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG164(MACRO, __VA_ARGS__) MACRO(165, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG166(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG165(MACRO, __VA_ARGS__) MACRO(166, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG167(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG166(MACRO, __VA_ARGS__) MACRO(167, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG168(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG167(MACRO, __VA_ARGS__) MACRO(168, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG169(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG168(MACRO, __VA_ARGS__) MACRO(169, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG170(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG169(MACRO, __VA_ARGS__) MACRO(170, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG171(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG170(MACRO, __VA_ARGS__) MACRO(171, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG172(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG171(MACRO, __VA_ARGS__) MACRO(172, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG173(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG172(MACRO, __VA_ARGS__) MACRO(173, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG174(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG173(MACRO, __VA_ARGS__) MACRO(174, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG175(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG174(MACRO, __VA_ARGS__) MACRO(175, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG176(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG175(MACRO, __VA_ARGS__) MACRO(176, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG177(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG176(MACRO, __VA_ARGS__) MACRO(177, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG178(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG177(MACRO, __VA_ARGS__) MACRO(178, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG179(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG178(MACRO, __VA_ARGS__) MACRO(179, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG180(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG179(MACRO, __VA_ARGS__) MACRO(180, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG181(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG180(MACRO, __VA_ARGS__) MACRO(181, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG182(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG181(MACRO, __VA_ARGS__) MACRO(182, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG183(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG182(MACRO, __VA_ARGS__) MACRO(183, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG184(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG183(MACRO, __VA_ARGS__) MACRO(184, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG185(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG184(MACRO, __VA_ARGS__) MACRO(185, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG186(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG185(MACRO, __VA_ARGS__) MACRO(186, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG187(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG186(MACRO, __VA_ARGS__) MACRO(187, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG188(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG187(MACRO, __VA_ARGS__) MACRO(188, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG189(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG188(MACRO, __VA_ARGS__) MACRO(189, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG190(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG189(MACRO, __VA_ARGS__) MACRO(190, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG191(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG190(MACRO, __VA_ARGS__) MACRO(191, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG192(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG191(MACRO, __VA_ARGS__) MACRO(192, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG193(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG192(MACRO, __VA_ARGS__) MACRO(193, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG194(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG193(MACRO, __VA_ARGS__) MACRO(194, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG195(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG194(MACRO, __VA_ARGS__) MACRO(195, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG196(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG195(MACRO, __VA_ARGS__) MACRO(196, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG197(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG196(MACRO, __VA_ARGS__) MACRO(197, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG198(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG197(MACRO, __VA_ARGS__) MACRO(198, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG199(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG198(MACRO, __VA_ARGS__) MACRO(199, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG200(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG199(MACRO, __VA_ARGS__) MACRO(200, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG201(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG200(MACRO, __VA_ARGS__) MACRO(201, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG202(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG201(MACRO, __VA_ARGS__) MACRO(202, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG203(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG202(MACRO, __VA_ARGS__) MACRO(203, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG204(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG203(MACRO, __VA_ARGS__) MACRO(204, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG205(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG204(MACRO, __VA_ARGS__) MACRO(205, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG206(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG205(MACRO, __VA_ARGS__) MACRO(206, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG207(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG206(MACRO, __VA_ARGS__) MACRO(207, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG208(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG207(MACRO, __VA_ARGS__) MACRO(208, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG209(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG208(MACRO, __VA_ARGS__) MACRO(209, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG210(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG209(MACRO, __VA_ARGS__) MACRO(210, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG211(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG210(MACRO, __VA_ARGS__) MACRO(211, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG212(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG211(MACRO, __VA_ARGS__) MACRO(212, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG213(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG212(MACRO, __VA_ARGS__) MACRO(213, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG214(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG213(MACRO, __VA_ARGS__) MACRO(214, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG215(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG214(MACRO, __VA_ARGS__) MACRO(215, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG216(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG215(MACRO, __VA_ARGS__) MACRO(216, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG217(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG216(MACRO, __VA_ARGS__) MACRO(217, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG218(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG217(MACRO, __VA_ARGS__) MACRO(218, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG219(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG218(MACRO, __VA_ARGS__) MACRO(219, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG220(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG219(MACRO, __VA_ARGS__) MACRO(220, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG221(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG220(MACRO, __VA_ARGS__) MACRO(221, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG222(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG221(MACRO, __VA_ARGS__) MACRO(222, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG223(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG222(MACRO, __VA_ARGS__) MACRO(223, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG224(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG223(MACRO, __VA_ARGS__) MACRO(224, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG225(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG224(MACRO, __VA_ARGS__) MACRO(225, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG226(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG225(MACRO, __VA_ARGS__) MACRO(226, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG227(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG226(MACRO, __VA_ARGS__) MACRO(227, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG228(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG227(MACRO, __VA_ARGS__) MACRO(228, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG229(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG228(MACRO, __VA_ARGS__) MACRO(229, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG230(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG229(MACRO, __VA_ARGS__) MACRO(230, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG231(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG230(MACRO, __VA_ARGS__) MACRO(231, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG232(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG231(MACRO, __VA_ARGS__) MACRO(232, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG233(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG232(MACRO, __VA_ARGS__) MACRO(233, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG234(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG233(MACRO, __VA_ARGS__) MACRO(234, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG235(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG234(MACRO, __VA_ARGS__) MACRO(235, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG236(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG235(MACRO, __VA_ARGS__) MACRO(236, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG237(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG236(MACRO, __VA_ARGS__) MACRO(237, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG238(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG237(MACRO, __VA_ARGS__) MACRO(238, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG239(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG238(MACRO, __VA_ARGS__) MACRO(239, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG240(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG239(MACRO, __VA_ARGS__) MACRO(240, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG241(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG240(MACRO, __VA_ARGS__) MACRO(241, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG242(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG241(MACRO, __VA_ARGS__) MACRO(242, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG243(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG242(MACRO, __VA_ARGS__) MACRO(243, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG244(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG243(MACRO, __VA_ARGS__) MACRO(244, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG245(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG244(MACRO, __VA_ARGS__) MACRO(245, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG246(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG245(MACRO, __VA_ARGS__) MACRO(246, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG247(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG246(MACRO, __VA_ARGS__) MACRO(247, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG248(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG247(MACRO, __VA_ARGS__) MACRO(248, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG249(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG248(MACRO, __VA_ARGS__) MACRO(249, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG250(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG249(MACRO, __VA_ARGS__) MACRO(250, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG251(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG250(MACRO, __VA_ARGS__) MACRO(251, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG252(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG251(MACRO, __VA_ARGS__) MACRO(252, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG253(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG252(MACRO, __VA_ARGS__) MACRO(253, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG254(MACRO, ...)                                                 \
	KAGUYA_VA_ARG(KAGUYA_PP_REPEAT_DEF_VA_ARG253(MACRO, __VA_ARGS__) MACRO(254, __VA_ARGS__))
#define KAGUYA_PP_REPEAT_DEF_VA_ARG(COUNT, MACRO, ...)                                             \
	KAGUYA_VA_ARG(KAGUYA_PP_CAT(KAGUYA_PP_REPEAT_DEF_VA_ARG, COUNT)(MACRO, __VA_ARGS__))
...
template <typename T, typename Ret, typename... Args> struct FunctorSignature<Ret (T::*)(Args...)> {
	typedef FunctionSignatureType<Ret, Args...> type;
};
...
template <typename T, typename = void> struct has_operator_fn : std::false_type {};
template <typename T>
struct has_operator_fn<
	T, typename std::enable_if<!std::is_same<void, decltype(&T::operator())>::value>::type>
	: std::true_type {};
...
template <std::size_t remain, class Arg, bool flag = remain <= 0> struct TypeIndexGet;
...
template <int N, typename F> struct ArgumentType {
	typedef typename TypeIndexGet<N, typename FunctionSignature<F>::type::argument_type_tuple>::type
		type;
};
...
template <KAGUYA_PP_STRUCT_TEMPLATE_DEF_REPEAT(KAGUYA_FUNCTION_MAX_ARGS)> struct TypeTuple {};
...
template <typename T, typename Enable = void> struct FunctionSignature;
	...
	#define KAGUYA_MEMBER_FUNCTION_SIGNATURE_DEF(N)                                                \
		...
		struct FunctionSignature<Ret (T::*)(KAGUYA_PP_TEMPLATE_ARG_REPEAT(N)) const> {             \
			typedef FunctionSignatureType<Ret, const T & KAGUYA_PP_TEMPLATE_ARG_REPEAT_CONCAT(N)>  \
				type;                                                                              \
		};
...
template <std::size_t remain, class result, bool flag = remain <= 0> struct TypeIndexGet {};
...
namespace detail {
	...
	#define KAGUYA_INVOKE_HELPER_DEF(N)                                                            \
		...
		typename FunctionResultType<F>::type invoke_helper(                                        \
			typename FunctionResultType<F>::type (T::*f)(KAGUYA_PP_TEMPLATE_ARG_REPEAT(N)),        \
			ThisType this_ KAGUYA_PP_ARG_DEF_REPEAT_CONCAT(N)) {                                   \
			return (this_.*f)(KAGUYA_PP_ARG_REPEAT(N));                                            \
		}                                                                                          \
		template <class F, class ThisType KAGUYA_PP_TEMPLATE_DEF_REPEAT_CONCAT(N), typename T>     \
		typename FunctionResultType<F>::type invoke_helper(                                        \
			typename FunctionResultType<F>::type (T::*f)(KAGUYA_PP_TEMPLATE_ARG_REPEAT(N)) const,  \
			ThisType this_ KAGUYA_PP_ARG_DEF_REPEAT_CONCAT(N)) {                                   \
			return (this_.*f)(KAGUYA_PP_ARG_REPEAT(N));                                            \
		}                                                                                          \
...
inline void
stackValueDump(std::ostream & os, lua_State * state, int stackIndex, int max_recursive = 2) {
...
struct ObjectSharedPointerWrapper : ObjectWrapperBase {
	...
	ObjectSharedPointerWrapper(const standard::shared_ptr<T> & sptr)
		: object_(standard::const_pointer_cast<typename standard::remove_const<T>::type>(sptr)),
		  ...
		  shared_ptr_type_(metatableType<standard::shared_ptr<typename traits::decay<T>::type>>()),
		  const_value_(traits::is_const<T>::value) {}
#if KAGUYA_USE_RVALUE_REFERENCE
	template <typename T>
	ObjectSharedPointerWrapper(standard::shared_ptr<T> && sptr)
		: object_(std::move(
			  standard::const_pointer_cast<typename standard::remove_const<T>::type>(sptr))),
		  type_(metatableType<T>()),
		  shared_ptr_type_(metatableType<standard::shared_ptr<typename traits::decay<T>::type>>()),
		  const_value_(traits::is_const<T>::value) {}
#endif
...
struct PointerConverter {
	...
	template <typename ToType, typename FromType> void add_type_conversion() {
		add_function(
			metatableType<ToType>(), metatableType<FromType>(),
			&base_pointer_cast<ToType, FromType>);
		add_function(
			metatableType<standard::shared_ptr<ToType>>(),
	...
	template <typename TO> const TO * get_const_pointer(ObjectWrapperBase * from) const {
		const std::type_info & to_type = metatableType<TO>();
		// unreachable
		// if (to_type == from->type())
		//{
	...
	standard::shared_ptr<TO> get_shared_pointer(ObjectSharedPointerWrapper * from) const {
		...
		std::map<convert_map_key, std::vector<shared_ptr_convert_function_type>>::const_iterator
			match =
				shared_ptr_function_map_.find(convert_map_key(to_type.name(), from_type.name()));
	...
	template <class T> T * get_pointer(ObjectWrapperBase * from, types::typetag<T>) {
		return get_pointer<T>(from);
	}
	template <class T>
	standard::shared_ptr<T>
	get_pointer(ObjectWrapperBase * from, types::typetag<standard::shared_ptr<T>>) {
  ...
  private:
	void add_function(
		const std::type_info & to_type, const std::type_info & from_type, convert_function_type f) {
	...
	void add_function(
		const std::type_info & to_type, const std::type_info & from_type,
		shared_ptr_convert_function_type f) {
		std::map<convert_map_key, std::vector<shared_ptr_convert_function_type>> add_map;
		for (std::map<convert_map_key, std::vector<shared_ptr_convert_function_type>>::iterator it =
	...
	void * pcvt_list_apply(void * ptr, const std::vector<convert_function_type> & flist) const {
		for (std::vector<convert_function_type>::const_iterator i = flist.begin(); i != flist.end();
			 ++i) {
			ptr = (*i)(ptr);
		}
		return ptr;
...
template <class T> const T * get_const_pointer(lua_State * l, int index, types::typetag<T>) {
	int type = lua_type(l, index);
...
template <class T> const T * get_pointer(lua_State * l, int index, types::typetag<const T>) {
...
inline standard::shared_ptr<void>
get_shared_pointer(lua_State * l, int index, types::typetag<void>) {
	ObjectSharedPointerWrapper * ptr =
		dynamic_cast<ObjectSharedPointerWrapper *>(object_wrapper(l, index));
...
template <typename T> void setmetatable(lua_State * l) { setmetatable(l, metatableType<T>()); }
} // namespace class_userdata
template <typename T>
...
template <typename T> inline optional<T> object_getopt(lua_State * l, int index) {
	const typename traits::remove_reference<T>::type * pointer =
		get_const_pointer(l, index, types::typetag<typename traits::remove_reference<T>::type>());
...
template <class To, class From, class... Remain> bool checkType(lua_State * l, int index) {
...
template <class To, class From, class... Remain> bool strictCheckType(lua_State * l, int index) {
...
template <class To, class From, class... Remain> To get(lua_State * l, int index) {
...
namespace conv_helper_detail {
	...
	#define KAGUYA_CONVERTIBLE_REG_HELPER_GET_OPT_TYPEDEF(N)                                       \
		typedef optional<typename lua_type_traits<KAGUYA_PP_CAT(A, N)>::get_type> KAGUYA_PP_CAT(   \
			opt_type, N);
...
template <typename To> bool checkType(lua_State *, int, TypeTuple<>) { return false; }
	#define KAGUYA_CONVERTIBLE_REG_HELPER_CHECK_TYPE_DEF(N)                                        \
		template <typename To, KAGUYA_PP_TEMPLATE_DEF_REPEAT(N)>                                   \
		bool checkType(                                                                            \
			lua_State * state, int index, TypeTuple<KAGUYA_PP_TEMPLATE_ARG_REPEAT(N)>) {           \
...
template <typename To> bool strictCheckType(lua_State *, int, TypeTuple<>) { return false; }
...
template <
	std::size_t first, std::size_t last, class result = index_tuple<>, bool flag = first >= last>
struct index_range {
	using type = result;
};
...
template <class... Args> struct lua_type_traits<standard::tuple<Args...>> {
	...
	#define KAGUYA_PUSH_TUPLE_DEF(N)                                                               \
		...
		struct lua_type_traits<standard::tuple<KAGUYA_PP_TEMPLATE_ARG_REPEAT(N)>> {                \
			static int                                                                             \
			push(lua_State * l, const standard::tuple<KAGUYA_PP_TEMPLATE_ARG_REPEAT(N)> & v) {     \
...
template <typename T>
struct lua_type_traits<T, typename traits::enable_if<traits::is_const_reference<T>::value>::type>
...
struct lua_type_traits<
	...
	static bool checkType(lua_State * l, int index) {
		int type = lua_type(l, index);
		if (type == LUA_TLIGHTUSERDATA || type == LUA_TNIL || type == LUA_TNONE) { return true; }
		return object_wrapper<T>(l, index) != 0;
	}
	static get_type get(lua_State * l, int index) {
		int type = lua_type(l, index);
...
template <typename T, typename Enable = void> struct has_optional_get : traits::false_type {};
template <typename T>
struct has_optional_get<
	T, typename traits::enable_if<
		   !traits::is_same<void, typename lua_type_traits<T>::opt_type>::value>::type>
	: traits::true_type {};
...
template <typename Derived> class LuaBasicTypeFunctions {
  ...
  private:
	...
	template <typename T> optional<typename lua_type_traits<T>::get_type> checkGet_() const {
		lua_State * state = state_();
		util::ScopedSavedStack save(state);
		int stackindex = pushStackIndex_(state);
...
#define KAGUYA_ENABLE_IF_NOT_LUAREF(RETTYPE)                                                       \
	typename traits::enable_if<                                                                    \
		!traits::is_convertible<T *, LuaBasicTypeFunctions<T> *>::value, RETTYPE>::type
...
struct ErrorHandler {
	...
	static void throwDefaultError(int status, const char * message = 0) {
		switch (status) {
			...
			case LUA_ERRMEM:
				throw LuaMemoryError(
					status, message ? std::string(message) : "lua memory allocation error");
			case LUA_ERRERR:
				throw LuaErrorRunningError(
					status, message ? std::string(message) : "unknown error running error");
#ifdef LUA_ERRGCMM
			case LUA_ERRGCMM:
  ...
  private:
#if KAGUYA_SUPPORT_MULTIPLE_SHARED_LIBRARY
	static const char * handlerRegistryKey() { return "\x80KAGUYA_ERROR_HANDLER_REGISTRY_KEY"; }
#else
...
class StackRef {
  protected:
	...
	~StackRef() {
		if (state_ && pop_) {
			if (lua_gettop(state_) >= stack_index_) { lua_settop(state_, stack_index_ - 1); }
		}
	}
...
class RegistoryRef {
  public:
	...
	template <typename T> RegistoryRef(lua_State * state, const T & v) : ref_(0, LUA_REFNIL) {
		if (!state) { return; }
		util::ScopedSavedStack save(state);
		util::one_push(state, v);
	...
	template <typename T> RegistoryRef(lua_State * state, T && v) : ref_(0, LUA_REFNIL) {
		if (!state) { return; }
		util::ScopedSavedStack save(state);
		util::one_push(state, standard::forward<T>(v));
		ref_ = RefHolder(util::toMainThread(state), ref_from_stacktop(state));
...
class FunctionResultProxy {
  public:
	...
	static RetType
	ReturnValue(lua_State * state, int restatus, int retindex, types::typetag<RetType> tag);
	static FunctionResults
	ReturnValue(lua_State * state, int restatus, int retindex, types::typetag<FunctionResults> tag);
	static void
	ReturnValue(lua_State * state, int restatus, int retindex, types::typetag<void> tag);
};
...
template <typename Derived> class LuaFunctionImpl {
  ...
  public:
	...
	template <class Result, class... Args> Result call(Args &&... args) {
		...
		return detail::FunctionResultProxy::ReturnValue(
			state, result, argstart, types::typetag<Result>());
	}
...
template <typename Derived> class LuaThreadImpl {
  ...
  public:
	...
	template <class Result, class... Args> Result resume(Args &&... args) {
		...
		return detail::FunctionResultProxy::ReturnValue(
			thread, result, nresult - (lua_gettop(state) + 1), types::typetag<Result>());
	}
	template <class... Args> FunctionResults operator()(Args &&... args);
#else
...
#if KAGUYA_USE_CPP11
	template <typename KEY> static void get(lua_State * state, int table_index, KEY && key) {
		util::one_push(state, std::forward<KEY>(key));
		lua_gettable(state, table_index);
	}
#endif
	template <typename KEY> static void get(lua_State * state, int table_index, const KEY & key) {
		util::one_push(state, key);
		lua_gettable(state, table_index);
	}
...
#if KAGUYA_USE_CPP11
	template <typename KEY> static void rawget(lua_State * state, int table_index, KEY && key) {
		util::one_push(state, std::forward<KEY>(key));
...
#else
	/// @brief table[key] = value;
	template <typename K, typename V> bool setField(const K & key, const V & value) {
		lua_State * state = state_();
		if (!state) {
			except::typeMismatchError(state, "is nil");
			return false;
...
template <typename Derived> class LuaTableImpl {
  ...
  public:
...
#else
	/// @brief rawset(table,key,value)
	template <typename K, typename V> bool setRawField(const K & key, const V & value) {
		lua_State * state = state_();
		if (!state) {
			except::typeMismatchError(state, "is nil");
			return false;
	...
	/// @brief If type is table or userdata, return keys.
	/// @return field keys
	template <typename K> std::vector<K> keys() const { return keys<K, std::allocator<K>>(); }
	...
	/// @brief If type is table or userdata, return values.
	/// @return field value
	template <typename V> std::vector<V> values() const { return values<V, std::allocator<V>>(); }
	std::vector<LuaRef> values() const;

	/// @brief If type is table or userdata, return key value pair.
	/// @return key value pair
	template <typename K, typename V, typename C, typename A> std::map<K, V, C, A> map() const {
		std::map<K, V, C, A> res;
...
get_result_tuple_impl(lua_State * l, int index, types::typetag<standard::tuple<T, TYPES...>>) {
...
get_result_impl(lua_State * l, int startindex, types::typetag<standard::tuple<TYPES...>> tag) {
	return get_result_tuple_impl<TYPES...>(l, startindex, tag);
}
#else

inline standard::tuple<>
get_result_impl(lua_State * l, int startindex, types::typetag<standard::tuple<>>) {
	KAGUYA_UNUSED(l);
...
class LuaRef : public Ref::RegistoryRef, public detail::LuaVariantImpl<LuaRef> {
  ...
  public:
	...
	template <typename T> LuaRef(lua_State * state, const T & v) : Ref::RegistoryRef(state, v) {}
...
class LuaFunction : public Ref::RegistoryRef,
  ...
  public:
	...
	template <typename F> LuaFunction(lua_State * state, F f) : Ref::RegistoryRef(state, f) {
		typecheck();
	}
	...
	/// @return reference of lua function
	static LuaStackRef
	loadstreamtostack(lua_State * state, std::istream & stream, const char * chunkname = 0) {
	...
	/// @return reference of lua function
	static LuaFunction
	loadstream(lua_State * state, std::istream & stream, const char * chunkname = 0) {
		util::ScopedSavedStack save(state);
		LuaLoadStreamWrapper wrapper(stream);
#if LUA_VERSION_NUM >= 502
		int status = lua_load(state, &LuaLoadStreamWrapper::getdata, &wrapper, chunkname, 0);
...
#else
namespace std {
template <> inline void swap(kaguya::LuaUserData & a, kaguya::LuaUserData & b) { a.swap(b); }
template <> inline void swap(kaguya::LuaTable & a, kaguya::LuaTable & b) { a.swap(b); }
template <> inline void swap(kaguya::LuaFunction & a, kaguya::LuaFunction & b) { a.swap(b); }
template <> inline void swap(kaguya::LuaThread & a, kaguya::LuaThread & b) { a.swap(b); }
template <> inline void swap(kaguya::LuaRef & a, kaguya::LuaRef & b) { a.swap(b); }
} // namespace std
#endif
// Copyright satoren
// Distributed under the Boost Software License, Version 1.0. (See
...
int _call_apply(
	lua_State * state, F && f, index_tuple<Indexes...>, util::FunctionSignatureType<Ret, Args...>) {
...
int _call_apply(
	lua_State * state, F && f, index_tuple<Indexes...>,
...
bool _ctype_apply(
	lua_State * state, index_tuple<Indexes...>, util::TypeTuple<Args...>, int opt_count) {
	KAGUYA_UNUSED(state);
...
template <class F> bool checkArgTypes(lua_State * state, const F &, int opt_count = 0) {
	typedef typename traits::decay<F>::type ftype;
	typedef typename util::FunctionSignature<ftype>::type fsigtype;
	typedef typename index_range<1, fsigtype::argument_count + 1>::type index;
...
template <class F> bool strictCheckArgTypes(lua_State * state, const F &, int opt_count = 0) {
	typedef typename traits::decay<F>::type ftype;
	typedef typename util::FunctionSignature<ftype>::type fsigtype;
	typedef typename index_range<1, fsigtype::argument_count + 1>::type index;
	typedef typename fsigtype::argument_type_tuple argument_type_tuple;
...
namespace nativefunction {
	...
	#define KAGUYA_FUNC_DEF(N)                                                                     \
		const util::FunctionSignatureType<Ret KAGUYA_PP_TEMPLATE_ARG_REPEAT_CONCAT(N)> & fsig
...
template <typename T> struct ConstructorFunctor;
	...
	#define KAGUYA_CONSTRUCTOR_CALL_FN_DEF(N)                                                      \
		...
		struct ConstructorFunctor<                                                                 \
			util::FunctionSignatureType<ClassType KAGUYA_PP_TEMPLATE_ARG_REPEAT_CONCAT(N)>> {      \
			typedef util::FunctionSignatureType<ClassType KAGUYA_PP_TEMPLATE_ARG_REPEAT_CONCAT(N)> \
				signature_type;                                                                    \
...
template <std::size_t remain, class result, bool flag = remain <= 0> struct tuple_element {};
...
template <size_t S, typename T> const typename tuple_element<S, T>::type & get(const T & t) {
...
struct is_callable
	: traits::integral_constant<
		  bool, !traits::is_same<void, typename util::FunctionSignature<T>::type>::value> {};
...
// for constructors
template <class T> int call(lua_State * state, ConstructorFunctor<T> & con) { return con(state); }
template <class T> int call(lua_State * state, const ConstructorFunctor<T> & con) {
	return con(state);
}
template <class T>
...
template <> struct is_callable<PolymorphicInvoker> : traits::integral_constant<bool, true> {};
...
template <> struct is_callable<PolymorphicMemberInvoker> : traits::integral_constant<bool, true> {};
} // namespace nativefunction
...
class VariadicArgType {
  public:
	...
	template <typename T> typename lua_type_traits<T>::get_type at(size_t index) const {
...
void function_match_scoring(
	lua_State * state, uint8_t * score_array, int current_index, const Fn & fn) {
...
template <typename TupleType> int invoke_tuple(lua_State * state, TupleType && tuple) {
	...
	typedef
		typename nativefunction::index_range<0, fntuple::tuple_size<ttype>::value>::type indexrange;
...
template <typename TupleType, std::size_t... S>
void push_arg_typename_tuple_impl(
	lua_State * state, TupleType && tuple, nativefunction::index_tuple<S...>) {
...
namespace detail {
	...
	#define KAGUYA_TUPLE_INVOKE_DEF(N)                                                             \
		...
		int invoke_tuple(                                                                          \
			lua_State * state, fntuple::tuple<KAGUYA_PP_TEMPLATE_ARG_REPEAT(N)> & tuple) {         \
...
template <typename T> inline FunctionInvokerType<fntuple::tuple<T>> function(T f) {
...
FunctionInvokerType<fntuple::tuple<Functions...>> overload(Functions... fns) {
	...
	#define KAGUYA_FOVERLOAD_DEF(N)                                                                \
		template <KAGUYA_PP_TEMPLATE_DEF_REPEAT(N)>                                                \
		FunctionInvokerType<fntuple::tuple<KAGUYA_PP_TEMPLATE_ARG_REPEAT(N)>> overload(            \
			KAGUYA_PP_ARG_DEF_REPEAT(N)) {                                                         \
...
template <typename FunctionTuple> struct lua_type_traits<FunctionInvokerType<FunctionTuple>> {
	...
	static const char *
	build_arg_error_message(lua_State * state, const char * msg, FunctionTuple * tuple) {
...
struct lua_type_traits<
	T, typename traits::enable_if<
		   traits::is_function<typename traits::remove_pointer<T>::type>::value>::type> {
	static int push(lua_State * l, T f) { return util::one_push(l, kaguya::function(f)); }
};
/// @ingroup lua_type_traits
...
template <typename T> struct lua_type_traits<standard::function<T>> {
	...
	static int push(lua_State * l, push_type v) { return util::one_push(l, kaguya::function(v)); }
};
...
struct OverloadFunctionImpl : kaguya::FunctionImpl {
	...
	virtual bool checkArgTypes(lua_State * state) const {
		return kaguya::nativefunction::checkArgTypes(
...
template <typename F> struct OverloadFunctionImpl<F, void> : kaguya::FunctionImpl {
...
#define KAGUYA_INTERNAL_OVERLOAD_MEMBER_FUNCTION_INVOKE(N, FNAME, MINARG, MAXARG)                  \
...
#define KAGUYA_MEMBER_FUNCTION_OVERLOADS_INTERNAL(                                                 \
	GENERATE_NAME, CLASS, FNAME, MINARG, MAXARG, CREATE_FN)                                        \
                                                                                                   \
	struct GENERATE_NAME {                                                                         \
		template <typename F> struct Function : kaguya::OverloadFunctionImpl<F> {                  \
			typedef typename kaguya::OverloadFunctionImpl<F>::result_type result_type;             \
			virtual result_type invoke_type(lua_State * state) {                                   \
				...
				KAGUYA_PP_REPEAT_DEF_VA_ARG(                                                       \
					KAGUYA_PP_INC(KAGUYA_PP_SUB(MAXARG, MINARG)),                                  \
					KAGUYA_INTERNAL_OVERLOAD_MEMBER_FUNCTION_INVOKE, FNAME, MINARG, MAXARG)        \
				throw kaguya::LuaTypeMismatch("argument count mismatch");                          \
			}                                                                                      \
...
#define KAGUYA_FUNCTION_OVERLOADS(GENERATE_NAME, FNAME, MINARG, MAXARG)                            \
	KAGUYA_FUNCTION_OVERLOADS_INTERNAL(GENERATE_NAME, FNAME, MINARG, MAXARG, create(FNAME))
...
#define KAGUYA_FUNCTION_OVERLOADS_WITH_SIGNATURE(GENERATE_NAME, FNAME, MINARG, MAXARG, SIGNATURE)  \
	KAGUYA_FUNCTION_OVERLOADS_INTERNAL(GENERATE_NAME, FNAME, MINARG, MAXARG, create<SIGNATURE>())
...
/// @param MINARG minimum arguments count
/// @param MAXARG maximum arguments count
#define KAGUYA_MEMBER_FUNCTION_OVERLOADS(GENERATE_NAME, CLASS, FNAME, MINARG, MAXARG)              \
...
class FunctionResults : public Ref::StackRef, public detail::LuaVariantImpl<FunctionResults> {
  ...
  public:
	...
	template <typename T> typename lua_type_traits<T>::get_type result_at(size_t index) const {
...
namespace detail {
template <typename RetType>
inline RetType FunctionResultProxy::ReturnValue(
	lua_State * state, int return_status, int retindex, types::typetag<RetType>) {
	return FunctionResults(state, return_status, retindex).get_result(types::typetag<RetType>());
}
inline FunctionResults FunctionResultProxy::ReturnValue(
	lua_State * state, int return_status, int retindex, types::typetag<FunctionResults>) {
	return FunctionResults(state, return_status, retindex);
}
inline void FunctionResultProxy::ReturnValue(
	lua_State * state, int return_status, int retindex, types::typetag<void>) {
...
template <unsigned int I> FunctionResults::reference get(const FunctionResults & res) {
...
#define KAGUYA_DELEGATE_FIRST_ARG_C KAGUYA_DELEGATE_FIRST_ARG,
	 ...
	 */
	FunctionResults operator()() { return KAGUYA_DELEGATE_LUAREF(KAGUYA_DELEGATE_FIRST_ARG); }
	KAGUYA_PP_REPEAT_DEF(KAGUYA_FUNCTION_MAX_ARGS, KAGUYA_OP_FN_DEF)
...
inline bool is_property_key(const char * keyname) {
	return keyname &&
		   strncmp(keyname, KAGUYA_PROPERTY_PREFIX, sizeof(KAGUYA_PROPERTY_PREFIX) - 1) != 0;
}
...
inline void setMembers(
	lua_State * state, int metatable_index, const MemberMapType & member_map,
...
template <typename class_type, typename base_class_type = void> class UserdataMetatable {
  public:
	UserdataMetatable() {
		...
		KAGUYA_STATIC_ASSERT(
			is_registerable<class_type>::value, "Can not register specialized of type conversion "
												"class. e.g. std::tuple");
	}
	...
	bool pushCreateMetatable(lua_State * state) const {
		if (!class_userdata::newmetatable<class_type>(state)) {
				...
				state, typeid(class_type *).name() + std::string(" is already registered"));
			return false;
		}
	...
	#define KAGUYA_SET_CON_FN_DEF(N)                                                               \
		template <KAGUYA_PP_TEMPLATE_DEF_REPEAT(N)> inline UserdataMetatable & setConstructors() { \
	...
	UserdataMetatable & addProperty(
		const char * name, GetType (class_type::*getter)() const,
	...
	template <typename GetType, typename SetType>
	UserdataMetatable & addProperty(
		const char * name, GetType (*getter)(const class_type *),
	...
	/// @param name function name for lua
	/// @param f function
	template <typename Fun> UserdataMetatable & addStaticFunction(const char * name, Fun f) {
		if (has_key(name)) {
			throw KaguyaException(std::string(name) + " is already registered.");
			return *this;
		}
	...
	/// @param name name for lua
	/// @param d data
	template <typename Data> UserdataMetatable & addStaticField(const char * name, Data && d) {
		if (has_key(name)) {
			throw KaguyaException(std::string(name) + " is already registered.");
			return *this;
		}
	...
	/// @param name name for lua
	/// @param d data
	template <typename Data> UserdataMetatable & addStaticField(const char * name, const Data & d) {
		if (has_key(name)) {
			throw KaguyaException(std::string(name) + " is already registered.");
			return *this;
		}
	...
	template <typename Fun> UserdataMetatable & addFunction(const char * name, Fun f) {
		if (has_key(name)) {
			throw KaguyaException(
				std::string(name) + " is already registered. To "
	...
	template <typename Ret> UserdataMetatable & addFunction(const char * name, Ret class_type::*f) {
		if (has_key(name)) {
			throw KaguyaException(
				std::string(name) + " is already registered. To "
									"overload a function, use "
  ...
  private:
	...
	void metatables(
		lua_State * state, int metabase_array_index, PointerConverter & pvtreg,
...
class TableKeyReferenceProxy : public detail::LuaVariantImpl<TableKeyReferenceProxy<KEY>> {
  public:
	...
	template <typename T, typename P> void setClass(const UserdataMetatable<T, P> & reg) {
		set_class(reg);
	}
  ...
  private:
	template <typename T, typename P> void set_class(const UserdataMetatable<T, P> & reg) {
		detail::table_proxy::set(state_, table_index_, key_, reg);
	}

	///!constructs the reference. Accessible only to kaguya::LuaRef itself
	TableKeyReferenceProxy(
		lua_State * state, int table_index, const KEY & key, int revstacktop, const NoTypeCheck &)
		: state_(state), stack_top_(revstacktop), table_index_(table_index), key_(key) {}
	...
	TableKeyReferenceProxy(const LuaRef & table, const KEY & key)
		...
		if (t != LUA_TTABLE) {
				...
				state_, lua_typename(state_, t) + std::string(" is not table"));
		}
	}
...
namespace detail {
template <typename T> inline bool LuaFunctionImpl<T>::setFunctionEnv(const LuaTable & env) {
	lua_State * state = state_();
...
template <typename T> inline LuaTable LuaFunctionImpl<T>::getFunctionEnv() const {
	lua_State * state = state_();
	util::ScopedSavedStack save(state);
	if (!state) {
		except::typeMismatchError(state, "is nil");
...
template <typename T> bool LuaTableOrUserDataImpl<T>::setMetatable(const LuaTable & table) {
	lua_State * state = state_();
	if (!state) {
		except::typeMismatchError(state, "is nil");
		return false;
...
template <typename T> std::vector<LuaRef> LuaTableImpl<T>::keys() const { return keys<LuaRef>(); }
...
class State {
  ...
  public:
	...
	void
	setErrorHandler(standard::function<void(int statuscode, const char * message)> errorfunction) {
		if (!state_) { return; }
		util::ScopedSavedStack save(state_);
	...
	bool
	dostream(std::istream & stream, const char * chunkname = 0, const LuaTable & env = LuaTable()) {
		util::ScopedSavedStack save(state_);
	...
	TableKeyReferenceProxy<std::string> operator[](const std::string & str) {
		...
		return TableKeyReferenceProxy<std::string>(
			state_, table_index, str, stack_top, NoTypeCheck());
	}
	...
	TableKeyReferenceProxy<const char *> operator[](const char * str) {
		...
		util::push_args(state_, GlobalTable());
		int table_index = stack_top + 1;
		return TableKeyReferenceProxy<const char *>(
			state_, table_index, str, stack_top, NoTypeCheck());
	}
	...
	template <typename T> LuaRef newRef(const T & value) { return LuaRef(state_, value); }
#if KAGUYA_USE_CPP11
	...
	/// @param value value
	template <typename T> void pushToStack(T value) { util::push_args(state_, value); }
